...
def run():
    ...
    for profile in SEARCH_PROFILES:
        ...
        search_query = f'"{keyword}" site:youtube.com/videos OR site:youtube.com/shorts OR site:instagram.com/reel OR site:instagram.com/video OR site:tiktok.com/video'
